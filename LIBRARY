if game.CoreGui:FindFirstChild("Library") then
  ...
  function Window(text, textgame, textcircle)
   ...
   function Notification(textdesc)
   ...
   function Tabs:Tab(text)
      ...
      function ContainerItems:Textbox(text, disapper, callback)
         ...
         TextBox.FocusLost:Connect(
            ...
            if (string.sub(string.lower(v.DisplayName),1,string.len(TextBox.Text))) == string.lower(TextBox.Text) or (string.sub(string.lower(v.Name),1,string.len(TextBox.Text))) == string.lower(TextBox.Text) then
